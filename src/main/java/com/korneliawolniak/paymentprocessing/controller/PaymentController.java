...
public class PaymentController {
    ...
    public PaymentController(PaymentFileParser paymentFileParser, PaymentLoader paymentLoader, PaymentValidator paymentValidator) {
    ...
    @PostMapping("/upload")
    public ResponseEntity<Payment> upload(@RequestParam("file") MultipartFile file) throws IOException {
